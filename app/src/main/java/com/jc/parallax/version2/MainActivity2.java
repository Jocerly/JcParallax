package com.jc.parallax.version2;
...
import com.jc.parallax.version2.utils.DisplayUtil;
import com.jc.parallax.version2.view.ParentViewPager;
import com.nineoldandroids.animation.AnimatorSet;
import com.nineoldandroids.animation.ObjectAnimator;
import com.nineoldandroids.view.ViewHelper;

/**
 * 小红书欢迎引导界面第二版 Created by zhongdaxia
 */
public class MainActivity2 extends FragmentActivity {
    ...
    private void playLogoInAnim() {
        ...
        ObjectAnimator anim3 =
            ObjectAnimator.ofFloat( iv_logo, "y", mLogoY, DisplayUtil.dip2px( MainActivity2.this, 15 ) );
        ...
        public Fragment getItem(int position) {
            switch ( position ) {
                case FRAGMENT_WELCOMEANIM:
                    ...
                    mWelcomAnimFragment.setWelcomAnimFragmentInterface(
                        new WelcomAnimFragment.WelcomAnimFragmentInterface() {
                            @Override
                            public void onSkip() {
    ...
    public void onBackPressed() {
        super.onBackPressed();
        vp_parent = null;
        mWelcomAnimFragment = null;
        mLoginAnimFragment = null;
    }
}
